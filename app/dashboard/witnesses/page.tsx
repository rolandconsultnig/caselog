      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Manage case witnesses and their statements
            </p>
          </div>
          <Link href="/dashboard/witnesses/new">
            <Button>
        ...
        <Card>
          <div className="flex gap-2 flex-wrap">
            ...
            <Button
              variant={filter === 'EYEWITNESS' ? 'primary' : 'outline'}
              onClick={() => setFilter('EYEWITNESS')}
            >
              Eyewitness
            </Button>
            <Button
              variant={filter === 'EXPERT' ? 'primary' : 'outline'}
              onClick={() => setFilter('EXPERT')}
            >
              Expert
            </Button>
            <Button
              variant={filter === 'CHARACTER' ? 'primary' : 'outline'}
        ...
        {loading ? (
          ...
          <Card>
            <div className="text-center py-12">
              ...
              <h3 className="mt-2 text-sm font-medium text-gray-900">No witnesses</h3>
              <p className="mt-1 text-sm text-gray-500">
                Get started by adding a new witness.
              </p>
              <div className="mt-6">
                <Link href="/dashboard/witnesses/new">
                  <Button>
          ...
          <div className="grid gap-4">
            {witnesses.map((witness) => (
              <Card key={witness.id} className="hover:shadow-lg transition-shadow">
                <Link href={`/dashboard/witnesses/${witness.id}`}>
